...
<head>
  ...
  <body>
    <div class="col-md-8 col-md-offset-2 text-center" id="page-footer">
        ...
        <!-- Go to the generator module -->
        <a href="generator.php">Generator</a> /
        <!-- Go to the user feedback module  -->
        <a href="UserEvaluation/index.html">Feedback (raptor)</a> /
				<!-- Go to the user feedback module external  -->
        <a href="http://co880.lewismckeown.com">Feedback (external)</a><br><br>
